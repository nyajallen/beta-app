 ...
 *
 * @param   feeling - List of all ChildActivities in the database.
 * @param   resources - Resources object for all the resources defined for our app.
 *
 * @return  Spanned - An interface for text that has formatting attached to it.
 *           See: https://developer.android.com/reference/android/text/Spanned
 */
fun formatFeelings(feeling: List<ChildActivity>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        feeling.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMilli) {
                ...
                append("\t${convertNumericQualityToString(it.activityQuality, resources)}<br>")
                append(resources.getString(R.string.hours_total))
                // Hours
